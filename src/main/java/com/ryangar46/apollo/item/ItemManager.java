...
public class ItemManager {
    ...
    public static final Item NEGATIVE_GRAVITY_BOOTS = new ArmorItem(NEGATIVE_GRAVITY_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Settings().group(ItemGroupManager.APOLLO));
    public static final ArmorMaterial POSITIVE_GRAVITY_ARMOR_MATERIAL = new GravityArmor(GravityArmor.Type.POSITIVE);
    public static final Item POSITIVE_GRAVITY_BOOTS = new ArmorItem(POSITIVE_GRAVITY_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Settings().group(ItemGroupManager.APOLLO));
